...
// ***********************  ДЛЯ РАЗРАБОТЧИКОВ  ***********************
byte BACKL_MODE = 1;                          // Выбранный активен при запуске и меняется кнопками
...
// пины
#define PIEZO    40      // пищалка
#define KEY0     2      // часы
#define KEY1     3      // часы 
#define KEY2     4      // минуты
#define KEY3     5      // минуты   
#define BTN1     10     // кнопка 1
#define BTN2     13     // кнопка 2
